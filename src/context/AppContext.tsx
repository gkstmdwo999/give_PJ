...
import { authAPI, chatAPI, dynamicQrAPI, notificationAPI, postAPI } from '@/src/services/api';
...
interface AppContextValue {
  ...
  updateLocation: (location: NeighborhoodLocation) => void;
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  function updateLocation(location: NeighborhoodLocation) {
